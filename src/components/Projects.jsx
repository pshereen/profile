      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg flex flex-row items-center gap-6">
          ...
          <div className="flex flex-col justify-between gap-2 flex-1">
            ...
            <p className="text-gray-700 text-sm">
            A full-stack Uber Eats clone app hosted on Render, allowing customers to browse restaurants, add items to a cart, and place orders. 
            Restaurant owners can manage menus and track orders through a dedicated dashboard with real-time updates.
            </p>
            <div className="flex justify-between items-center mt-2">
              <div className="flex items-center gap-3">
                <a
